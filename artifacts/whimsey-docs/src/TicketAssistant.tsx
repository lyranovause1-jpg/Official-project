    ...
    <div className="min-h-screen bg-[#fafafa]">
      ...
      <header className="sticky top-0 z-20 bg-white border-b border-gray-100 px-5 py-3 flex items-center gap-3">
        ...
        <nav className="flex items-center gap-2">
          <Link href="/"><button className="px-3 py-1.5 text-xs font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-colors">Home</button></Link>
          <Link href="/simulator"><button className="px-3 py-1.5 text-xs font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-colors">Drills</button></Link>
          <Link href="/permissions"><button className="px-3 py-1.5 text-xs font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-colors">Permissions</button></Link>
          <Link href="/ai"><button className="px-3 py-1.5 text-xs font-semibold bg-pink-500 hover:bg-pink-600 text-white rounded-lg transition-colors shadow-sm">💗 Ask AI</button></Link>
        </nav>
      </header>
