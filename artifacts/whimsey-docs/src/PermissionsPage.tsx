...
const ENTITIES: Entity[] = [
  {
    ...
    autonomous: [
      ...
      { text: "Monitor conversations, tone, spam, and momentum" },
      { text: "Post updates, alerts, and observations to #staff-chat" },
      { text: "Post to any private/internal channel" },
      { text: "Check live server status, member count, bot list" },
      { text: "Read audit log" },
      { text: "Check roles, channels, invites" },
      { text: "Kick a member" },
      { text: "Ban a member" },
    ...
    needsOk: [
      ...
      { text: "Post to any channel the community can see", public: true },
    ],
  },
  {
    name: "Carl-bot",
